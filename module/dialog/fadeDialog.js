...
export class fadeDialog {
    ...
    static async getYesNoDialog(dataset) {
        const { title = game.i18n.localize('FADE.dialog.confirm'), content = game.i18n.localize('FADE.dialog.confirm'), yesLabel = game.i18n.localize('FADE.dialog.yes'), noLabel = game.i18n.localize('FADE.dialog.no'), defaultChoice = "no" } = dataset;
