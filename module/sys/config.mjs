...
FADE.CombatManeuvers = {
    ...
    withdrawal: { phase: "melee", attackAfter: true, canMove: true },
    retreat: { phase: "melee", canMove: true },
    lance: { phase: "melee", needWeapon: true, needAbility: true, classes: ["fighter", "dwarf", "elf"], canMove: true },
    multiAttack: { phase: "melee", needAbility: true, classes: ["fighter", "dwarf", "elf", "halfling"], canMove: true },
    setSpear: { phase: "melee", attackBefore: true, needWeapon: true, needAbility: true, classes: ["fighter", "dwarf", "elf", "halfling", "mystic"], canMove: true },
    smash: { phase: "specialEnd", needAbility: true, classes: ["fighter", "dwarf", "elf", "halfling", "mystic"], special: true, canMove: true },
    parry: { phase: "melee", needAbility: true, classes: ["fighter", "dwarf", "elf", "halfling", "mystic"], special: true, canMove: true },
