...
export class FDActorSheetV2 extends DragDropMixin(HandlebarsApplicationMixin(ActorSheetV2)) {
    ...
    * @param {any} event
    */
   static async #clickEffect(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static #clickDeleteTag(this: FDActorSheetV2, event) {
   ...
   */
    ...
    * @param {any} event
    */
   static async #clickRollAbility(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickRollMorale(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickUseConsumable(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickAddConsumable(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickUseCharge(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickAddCharge(this: FDActorSheetV2, event) {
      await this._useCharge(event, false);
   }

   static async #clickEditAbilityScores(this: FDActorSheetV2, event) {
    ...
    * @param {any} event
    */
   static async #clickDeleteActorGroup(this: FDActorSheetV2, event) {
